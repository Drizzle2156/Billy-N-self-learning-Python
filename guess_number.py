...
# from arcade import arcade_main this causes a circular import error


def guessnumber_main(name='None'):  # outer function
    game_count = 0
    player_wins = 0
...
def test2():
    print("This is the guess# file")

# second_game = guessnumber_main()
# guessnumber_main()
...
if __name__ == "__main__":
    ...
    second_game = guessnumber_main(args.name)
    second_game()
